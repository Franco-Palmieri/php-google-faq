...
$faqs = [
    ...
    <ol><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti: <ul>
...
<body>
    ...
    <main>
            <?php
            foreach($faqs as $faq){
                echo "<div class=\"content\"><h2 class=\"question\">{$faq['question']}</h2> <div class=\"answer\">{$faq['answer']}</div>";
            }
            ?>
    </main>
    </div>
